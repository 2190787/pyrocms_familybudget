...
return [
    ...
    'characteristics' => [
        ...
        'option' => [
            'read'   => 'Can read characteristics?',
            'write'  => 'Can create/edit characteristics?',
            'delete' => 'Can delete characteristics?',
        ],
    ],
    'productscharacteristics' => [
        'name'   => 'Productscharacteristics',
        'option' => [
            'read'   => 'Can read productscharacteristics?',
            'write'  => 'Can create/edit productscharacteristics?',
            'delete' => 'Can delete productscharacteristics?',
        ],
    ],
];
